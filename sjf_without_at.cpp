[4:09 pm, 08/11/2022] AAKASH: void display(int process[],int n,int at[],int bt[],int ct[],int tat[],int wt[])
{
    cout<<"Process ID     Arrival Time    Burst Time         Com…
[4:33 pm, 08/11/2022] Ayush Katiya: #include <iostream>
#include<algorithm>
using namespace std;
